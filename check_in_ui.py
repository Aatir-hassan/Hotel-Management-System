...
class CheckIN:
    ...
    def __init__(self, root):
        ...
        # display message
        self.label = Label(self.top, font=('Helvetica', 50, 'italic bold'), bg="#F3B95F", text="CHECK IN", fg="#141E46", anchor="center")
        self.label.grid(row=0, column=3, padx=10, pady=50)

        # name label
        self.name_label = Label(self.bottom, font=('Helvetica', 20, 'italic bold'), text="ENTER YOUR NAME :", fg="#141E46",
                                anchor="w")
        ...
        # address label
        self.address_label = Label(self.bottom, font=('Helvetica', 20, 'italic bold'), text="ENTER YOUR ADDRESS :", fg="#141E46",
                                   anchor="w")
        ...
        self.mobile_label = Label(self.bottom, font=('Helvetica', 20, 'italic bold'), text="ENTER YOUR MOBILE NUMBER :",
                                  fg="#141E46",
                                  anchor="w")
        ...
        self.days_label = Label(self.bottom, font=('Helvetica', 20, 'italic bold'), text="ENTER NUMBER OF DAYS TO STAY :",
                                fg="#141E46",
                                anchor="w")
        ...
        # room number label
        self.room_number_label = Label(self.bottom, font=('Helvetica', 20, 'italic bold'), text="ROOM NUMBER: ",
                                       fg="#141E46",
                                       anchor="w")
        self.room_number_label.grid(row=4, column=2, padx=10, pady=20)
        ...
        self.room_entry.grid(row=4, column=3, padx=10, pady=20)
        ...
        Button(self.checkbox, text="RESET", font=('Helvetica', 20, 'italic bold'), bg="#F3B95F", relief=RIDGE, height=2, width=15, fg="#141E46",
               anchor="center", command=reset).grid(row=5, column=1)
    
        # back to home page
        self.back_home_button = Button(self.checkbox, text="HOME", font=('Helvetica', 20, 'italic bold'), bg="#F3B95F", relief=RIDGE, height=2,
                                       width=15,
                                       fg="#141E46", anchor="center", command=main.home_ui)
        self.back_home_button.grid(row=5, column=3, padx=10, pady=30)
        
         # create submit button
        self.submit_button = Button(self.checkbox, text="SUBMIT", font=('Helvetica', 20, 'italic bold'), bg="#F3B95F", relief=RIDGE, height=2,
                                    width=25,
                                    fg="#141E46", anchor="center", command=submit_info)
        self.submit_button.grid(row=5, column=2, padx=10, pady=30)
