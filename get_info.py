...
class GetInfo:
    def __init__(self, root):
        ...
        # display message
        self.label = Label(top, font=('Helvetica', 50, 'italic bold'), text="INFORMATION OF CUSTOMER",bg="#F3B95F", fg="#141E46",
                           anchor="center")
        ...
        self.submit_button = Button(button_frame, text="SUBMIT", font=('Helvetica', 15, 'italic bold'), bg="#F3B95F", relief=RIDGE, height=2,
                                    width=15, fg="#141E46", anchor="center", command=get_info)
        self.submit_button.grid(row=8, column=2, padx=10, pady=10)

        # create home button
        self.home_button = Button(button_frame, text="HOME", font=('Helvetica', 15, 'italic bold'), bg="#F3B95F", relief=RIDGE, height=2,
                                  width=15, fg="#141E46", anchor="center", command=main.home_ui)
